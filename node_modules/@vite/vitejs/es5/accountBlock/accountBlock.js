...
var AccountBlockClass = (function () {
    function AccountBlockClass(_a, provider, privateKey) {
        ...
        var err = (0, vitejs_utils_1.checkParams)({ blockType: blockType, address: address }, ['blockType', 'address'], [{
                name: 'blockType',
                func: function (_b) { return type_1.BlockType[_b]; },
                msg: "Don't have blockType ".concat(blockType)
            }, {
                name: 'address',
    ...
    Object.defineProperty(AccountBlockClass.prototype, "toAddress", {
        get: function () {
            ...
            return (0, utils_1.createContractAddress)({
                address: this.address,
                height: this.height,
    ...
    Object.defineProperty(AccountBlockClass.prototype, "originalAddress", {
        get: function () {
            return (0, address_1.getOriginalAddressFromAddress)(this.address);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "blockTypeHex", {
        get: function () {
            return (0, utils_1.getBlockTypeHex)(this.blockType);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "previousHashHex", {
        get: function () {
            return (0, utils_1.getPreviousHashHex)(this.previousHash);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "heightHex", {
        get: function () {
            return (0, utils_1.getHeightHex)(this.height);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "addressHex", {
        get: function () {
            return (0, utils_1.getAddressHex)(this.address);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "toAddressHex", {
        get: function () {
            return (0, utils_1.getToAddressHex)(this.toAddress);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "amountHex", {
        get: function () {
            return (0, utils_1.getAmountHex)(this.amount);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "tokenIdHex", {
        get: function () {
            return (0, utils_1.getTokenIdHex)(this.tokenId);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "sendBlockHashHex", {
        get: function () {
            return (0, utils_1.getSendBlockHashHex)(this.sendBlockHash);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "dataHex", {
        get: function () {
            return (0, utils_1.getDataHex)(this.data);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "feeHex", {
        get: function () {
            return (0, utils_1.getFeeHex)(this.fee);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "nonceHex", {
        get: function () {
            return (0, utils_1.getNonceHex)(this.nonce);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "isRequestBlock", {
        get: function () {
            return (0, utils_1.isRequestBlock)(this.blockType);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "isResponseBlock", {
        get: function () {
            return (0, utils_1.isResponseBlock)(this.blockType);
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(AccountBlockClass.prototype, "hash", {
        get: function () {
            ...
            if ((0, utils_1.isValidAccountBlockWithoutHash)(block)) {
                return (0, utils_1.getAccountBlockHash)(block);
            }
            return null;
        },
        enumerable: false,
    ...
    AccountBlockClass.prototype.getDifficulty = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        err = (0, vitejs_utils_1.checkParams)(this.accountBlock, ['previousHash']);
                        if (err) {
                            throw err;
                        }
    ...
    AccountBlockClass.prototype.getNonce = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                err = (0, vitejs_utils_1.checkParams)({
                    difficulty: this.difficulty,
                    previousHash: this.previousHash
    ...
    AccountBlockClass.prototype.setPublicKey = function (publicKey) {
        var err = (0, vitejs_utils_1.checkParams)({ publicKey: publicKey }, ['publicKey'], [{
                name: 'publicKey',
                func: function (_p) { return (0, vitejs_utils_1.isHexString)(_p) || (0, vitejs_utils_1.isBase64String)(_p); },
                msg: 'PublicKey is Hex-string or Base64-string'
            }]);
        if (err) {
            throw err;
        }
        var publicKeyHex = (0, vitejs_utils_1.isHexString)(publicKey)
            ? publicKey
            : Buffer.from("".concat(publicKey), 'base64').toString('hex');
        var publicKeyBase64 = (0, vitejs_utils_1.isHexString)(publicKey)
            ? Buffer.from("".concat(publicKey), 'hex').toString('base64')
            : publicKey;
        var address = (0, address_1.getAddressFromPublicKey)(publicKeyHex);
    ...
    AccountBlockClass.prototype.setSignature = function (signature) {
        var err = (0, vitejs_utils_1.checkParams)({ signature: signature }, ['signature'], [{
                name: 'signature',
                func: function (_s) { return (0, vitejs_utils_1.isHexString)(_s) || (0, vitejs_utils_1.isBase64String)(_s); },
                msg: 'Signature is Hex-string or Base64-string'
            }]);
        if (err) {
            throw err;
        }
        if ((0, vitejs_utils_1.isBase64String)(signature)) {
    ...
    AccountBlockClass.prototype.sign = function (privateKey) {
        ...
        var _a = (0, utils_1.signAccountBlock)(this.accountBlock, privateKey), signature = _a.signature, publicKey = _a.publicKey;
    ...
    AccountBlockClass.prototype.send = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        err = (0, utils_1.checkAccountBlock)(this.accountBlock);
                        if (err) {
                            throw err;
                        }
                        _a.label = 1;
