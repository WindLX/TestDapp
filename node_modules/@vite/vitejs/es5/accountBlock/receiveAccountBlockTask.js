...
var sleep = function (ms) { return setTimeout(function () { return Promise.resolve(); }, ms); };
var ReceiveAccountBlockTask = (function () {
    function ReceiveAccountBlockTask(_a) {
        ...
        var err = (0, vitejs_utils_1.checkParams)({ address: address, provider: provider, privateKey: privateKey }, ['address', 'provider'], [{
                name: 'address',
                ...
                func: function (str) {
                    ...
                    return (0, vitejs_utils_1.isHexString)(str);
                }
            }]);
        if (err) {
            throw err;
    ...
    ReceiveAccountBlockTask.prototype.start = function (_a) {
        ...
        var _b = _a === void 0 ? {
            ...
            transactionNumber: 5,
            gapTime: 1000
        } : _a, _c = _b.checkTime, checkTime = _c === void 0 ? 3000 : _c, _d = _b.transactionNumber, transactionNumber = _d === void 0 ? 5 : _d, _e = _b.gapTime, gapTime = _e === void 0 ? 1000 : _e;
        this.stop();
        var toReceive = function () {
            _this._timer = setTimeout(function () { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.receive(transactionNumber, gapTime)];
                        case 1:
                            _a.sent();
                            if (!this._timer) {
                                return [2];
    ...
    ReceiveAccountBlockTask.prototype.receive = function (pageSize, gapTime) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        _a.label = 5;
                    case 5:
                        if (!(_i < unreceivedBlocks_1.length)) return [3, 12];
                    ...
                    case 8:
                        ...
                        this.emitError({
                            message: "Receive accountBlock ".concat(sendBlockHash, " error"),
                            unreceivedHash: sendBlockHash,
                            error: error_2
                        });
                        return [2];
                    case 9: return [4, sleep(gapTime)];
                    case 10:
                        _a.sent();
                        _a.label = 11;
                    case 11:
