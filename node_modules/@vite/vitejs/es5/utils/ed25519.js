...
exports.random = exports.verify = exports.sign = exports.getPublicKey = exports.keyPair = void 0;
...
function getPublicKey(privKey) {
    var err = (0, index_1.checkParams)({ privKey: privKey }, ['privKey']);
    if (err) {
...
function sign(hexStr, privKey) {
    var err = (0, index_1.checkParams)({ hexStr: hexStr, privKey: privKey }, ['hexStr', 'privKey'], [{
            name: 'hexStr',
...
function verify(message, signature, publicKey) {
    var err = (0, index_1.checkParams)({ message: message, signature: signature, publicKey: publicKey }, ['message', 'signature', 'publicKey'], [{
            name: 'message',
            func: index_1.isHexString
        }, {
            name: 'signature',
...
function random(bytesLen) {
    ...
    var err = (0, index_1.checkParams)({ bytesLen: bytesLen }, ['bytesLen']);
    if (err) {
        throw new Error(err.message);
    }
