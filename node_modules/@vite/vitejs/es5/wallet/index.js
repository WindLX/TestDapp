...
exports.default = __assign(__assign(__assign({}, addressLib), hdKey), { deriveAddress: deriveAddress, deriveAddressList: function (_a) {
        ...
        var err = (0, vitejs_utils_1.checkParams)({ startIndex: startIndex, endIndex: endIndex }, ['startIndex', 'endIndex']);
        if (err) {
        ...
        if (wordlist === void 0) { wordlist = bip39.wordlists.EN; }
        if (passphrase === void 0) { passphrase = ''; }
        var err = (0, vitejs_utils_1.checkParams)({ mnemonics: mnemonics, wordlist: wordlist }, ['mnemonics', 'wordlist'], [{
                name: 'mnemonics',
