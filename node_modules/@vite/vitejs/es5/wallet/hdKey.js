...
function createMnemonics(strength, wordlist) {
    ...
    var err = (0, vitejs_utils_1.checkParams)({ strength: strength, wordlist: wordlist }, ['strength', 'wordlist']);
    if (err) {
...
function getEntropyFromMnemonics(mnemonic, wordlist) {
    if (wordlist === void 0) { wordlist = bip39.wordlists.EN; }
    var err = (0, vitejs_utils_1.checkParams)({ mnemonic: mnemonic, wordlist: wordlist }, ['mnemonic', 'wordlist'], [{
            name: 'mnemonic',
...
function getMnemonicsFromEntropy(entropy, wordlist) {
    if (wordlist === void 0) { wordlist = bip39.wordlists.EN; }
    var err = (0, vitejs_utils_1.checkParams)({ entropy: entropy }, ['entropy']);
    if (err) {
        throw new Error(err.message);
    }
...
function getPath(index) {
    return "".concat(exports.ROOT_PATH, "/").concat(index, "'");
}
