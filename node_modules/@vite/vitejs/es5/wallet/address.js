...
function createAddressByPrivateKey(privateKey) {
    var err = (0, vitejs_utils_1.checkParams)({ privateKey: privateKey }, [], [{
            name: 'privateKey',
...
function getAddressFromOriginalAddress(originalAddress) {
    var err = (0, vitejs_utils_1.checkParams)({ originalAddress: originalAddress }, ['originalAddress'], [{
...
function getOriginalAddress(hexAddr, addrType) {
    ...
    if (addrType === AddressType.Account) {
        return "".concat(addr, "00");
    }
    return "".concat(addr, "01");
}
...
function newAddrFromPub(publicKey) {
    var _pre = (0, vitejs_utils_1.blake2b)(publicKey, null, exports.ADDR_SIZE);
...
function getAddrCheckSum(addr, isContract) {
    ...
    var _checkSum = (0, vitejs_utils_1.blake2b)(addrPre20, null, exports.ADDR_CHECK_SUM_SIZE);
